...
var canReflectGetSet = require('can-reflect/reflections/get-set/get-set');
//var canSymbol = require('can-symbol');
...
var COMPUTE = function (getterSetter, context, eventName, bindOnce) {
	...
	canReflectGetSet.set(compute, canOnValueSymbol, onValue);
	canReflectGetSet.set(compute, canOffValueSymbol, offValue);
	canReflectGetSet.set(compute, canGetValue, getValue);
	canReflectGetSet.set(compute, canSetValue, setValue);
	canReflectGetSet.set(compute, isValueLike, true);
	canReflectGetSet.set(compute, isMapLike, false);
	canReflectGetSet.set(compute, isListLike, false);
	canReflectGetSet.set(compute, isFunctionLike, false);
	canReflectGetSet.set(compute, canValueHasDependencies, hasDependencies);
	canReflectGetSet.set(compute, canGetValueDependencies, getDependencies);
	return compute;
};
