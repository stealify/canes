...
// observer keys
var dispatchInsertion = batch(dispatch("domMutationInsertionData", "domMutationDocumentInsertionData"), true);
var dispatchRemoval = batch(dispatch("domMutationRemovalData", "domMutationDocumentRemovalData"), true);
var dispatchAttributeChange = batch(dispatch("domMutationAttributeChangeData", "domMutationDocumentAttributeChangeData"));
...
*/
var onNodeInsertion = addNodeListener("domMutationInsertionData", "domMutationTreeData");
...
* @return {function} The callback to remove the mutation listener.
*/
var onNodeRemoval = addNodeListener("domMutationRemovalData", "domMutationTreeData");
...
* @return {function} The callback to remove the mutation listener.
*/
function onNodeAttributeChange(){ return addNodeListener("domMutationAttributeChangeData", "domMutationAttributeData", true); } 
...
* @return {function} The callback to remove the mutation listener.
*/
function onInsertion(...restArgs){ return addGlobalListener("domMutationDocumentInsertionData", onNodeInsertion); }
...
* @return {function} The callback to remove the mutation listener.
*/
var onRemoval = addGlobalListener("domMutationDocumentRemovalData", onNodeRemoval);

var onAttributeChange = addGlobalListener("domMutationDocumentAttributeChangeData",onNodeAttributeChange);
...
*/
function dispatchNodeInsertion(node, callback) {
...
* @param {function} callback The optional callback called after the mutation is dispatched.
*/
function dispatchNodeRemoval(node, callback) {
  var events = toMutationEvents(getAllNodes(node));
...
* @param {function} callback The optional callback called after the mutation is dispatched.
*/
function dispatchNodeAttributeChange(target, attributeName, oldValue, callback) {
